...
const Logo: FC<SVGProps<SVGSVGElement>> = props => (
  ...
  >
    ...
    ></path>
    <defs>
      <linearGradient id=":S2:-g" x1="15.88" y1="0" x2="15.88" y2="32" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fbffaa"></stop>
        <stop offset="1" stopColor="#f8c538"></stop>
      </linearGradient>
    </defs>
  </svg>
);
